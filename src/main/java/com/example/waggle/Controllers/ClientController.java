    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        Models.getInstance().getViewManage().getClientSelectedMenuItem().addListener((observableValue, oldVal, newVal) -> {
            switch (newVal) {
                ...
                case "AddVolunteer" -> Client_parent.setCenter(Models.getInstance().getViewManage().getAddVolunteerFormView());
                ...
                case "addSponsor" -> Client_parent.setCenter(Models.getInstance().getViewManage().getAddSponsorFormView());
                case "addKeeping" -> Client_parent.setCenter(Models.getInstance().getViewManage().getAddKeepingFormView());
